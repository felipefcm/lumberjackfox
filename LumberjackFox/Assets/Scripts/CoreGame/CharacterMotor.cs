...
public class CharacterMotor : MonoBehaviour
{
    ...
    private Vector3 ApplyGravityAndJumping(Vector3 velocity)
    {
        ...
        if((inputJump && jumping.lastButtonDownTime < 0 && canControl) || requestJump){
        ...
        if(grounded)
        {
            ...
            if(jumping.enabled && canControl && (Time.time - jumping.lastButtonDownTime < 0.2))
            {
                ...
                velocity.y = 0;
                velocity += jumping.jumpDir * CalculateJumpVerticalSpeed(jumping.baseHeight*movement.jumpForce);
